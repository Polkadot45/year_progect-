...
public class Size {
    public static void initSize(
        ...
        backgrounds.put("end_knyrov", new Game.Rect("end_knyrov", 0, 0, 1920, 1080));
        backgrounds.put("end_karandash", new Game.Rect("end_karandash", 0, 0, 1920, 1080));
        ...
        buttons.put("back", new Game.Rect("stop", 1800, 30, 80, 80));
        ...
        buttons.put("sbros", new Game.Rect("sbros", 735, 450, 60, 43)); //set_reset
        ...
        characters.put("larusaC", new Game.Rect("larusaC", 1050, 200, 850, 850));
